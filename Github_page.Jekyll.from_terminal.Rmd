...
* If there are issues with nokogiri, ignore flag (as seen [here](http://stackoverflow.com/questions/19643153/error-to-install-nokogiri-on-osx-10-9-maverick):
```
...
5. If bundle advises to filter dependencies, make the Gemfile look like this:
```
...
6. Build Webpage as desired


7. Go to your `gh-pages` branch and run Jekyll (using bundle):
```
