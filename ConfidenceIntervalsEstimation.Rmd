...
* You can find the R Scripts for this entry: [fig.1](https://github.com/darokun/Others/blob/master/NDistPlotForCI.R), [fig.2](https://github.com/darokun/Others/blob/master/tDistAgainstNormalPlot.R), [Confidence Interval Estimation](https://github.com/darokun/Others/blob/master/ConfidenceIntervalsEstimation.R).
