...
Now we want to leave our $\mu$ alone, so we do a little bit of algebra, and we end up with:
...
$$CI_{1-\alpha/2} = \overline{x} \pm qnorm\left(1-\frac{\alpha}{2}\right) 
\times \sqrt{\frac{\sigma^2}{n}}$$
...
* You can find the R Scripts for this entry: [fig.1](https://github.com/darokun/Others/blob/master/NDistPlotForCI.R), [fig.2](https://github.com/darokun/Others/blob/master/tDistAgainstNormalPlot.R), [Confidence Interval Estimation](https://github.com/darokun/Others/blob/master/ConfidenceIntervalsEstimation.R), [RMarkdown](https://github.com/darokun/Others/blob/master/ConfidenceIntervalsEstimation.Rmd).
